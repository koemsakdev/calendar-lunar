...
export class PublicHolidaysService {
  readonly events: CalendarEvent[] = [
    {
      summary: { kh: 'ទិវាចូលឆ្នាំសកល', en: 'International New Year Day' },
      description: 'Holiday in Cambodia',
      start_date: { day: 1, month: 1 },
      date: null, image: '',
    },
    {
      summary: { kh: 'ទិវាជ័យជំនះលើរបបប្រល័យពូជសាសន៍', en: 'Day of Victory over the Genocidal Regime' },
      description: 'Holiday in Cambodia',
      start_date: { day: 7, month: 1 },
      date: null, image: '',
    },
    {
      summary: { kh: 'ទិវានារីអន្តរជាតិ', en: "International Women's Rights Day" },
      description: 'Holiday in Cambodia',
      start_date: { day: 8, month: 3 },
      date: null, image: '',
    },
    {
      summary: { kh: 'ទិវាពលកម្មអន្តរជាតិ', en: 'International Labor Day' },
      description: 'Holiday in Cambodia',
    ...
    {
      summary: { kh: 'ទិវាជាតិសុខភាពមាតា និងទារក', en: 'National Day on Maternal, Newborn and Child Health' },
      description: 'General Event',
    ...
    {
      summary: { kh: 'ទិវាពិភពលោកកំចាត់ជម្ងឺរបេង', en: 'World Tuberculosis Day' },
      description: 'General Event',
  ...
  readonly traditionalEvents: TraditionalEvent[] = [
    {
      summary: { kh: 'ពិធីបុណ្យ​វិសាខបូជា', en: 'Visaka Bochea Day' },
      description: 'Holiday in Cambodia',
      start_date: { day: '១៥កើត', month: 'ពិសាខ' },
      image: '',
    },
    {
      summary: { kh: 'ពិធីបុណ្យភ្ជុំបិណ្ឌ', en: 'Pchum Ben Festival' },
      description: 'Holiday in Cambodia',
    ...
    {
      summary: { kh: 'ព្រះរាជ​ពិធីបុណ្យ​អុំទូក បណ្តែតប្រទីប និង​សំពះព្រះខែ អកអំបុក', en: 'Water Festival' },
      description: 'Holiday in Cambodia',
      start_date: { day: '១៤កើត', month: 'កក្ដិក' },
      image: '',
    },
    {
      summary: { kh: 'ព្រះរាជ​ពិធីបុណ្យ​អុំទូក បណ្តែតប្រទីប និង​សំពះព្រះខែ អកអំបុក', en: 'Water Festival' },
      description: 'Holiday in Cambodia',
      start_date: { day: '១៥កើត', month: 'កក្ដិក' },
      image: '',
    },
    {
      summary: { kh: 'ព្រះរាជ​ពិធីបុណ្យ​អុំទូក បណ្តែតប្រទីប និង​សំពះព្រះខែ អកអំបុក', en: 'Water Festival' },
      description: 'Holiday in Cambodia',
      start_date: { day: '១រោច', month: 'កក្ដិក' },
      image: '',
    },
    {
      summary: { kh: 'ព្រះរាជពិធីច្រត់ព្រះនង្គ័ល', en: 'Royal Ploughing Ceremony' },
      description: 'Holiday in Cambodia',
